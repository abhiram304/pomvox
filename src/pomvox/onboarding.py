...
MARKER_PATH = Path.home() / ".pomvox" / "onboarded"
...
RELAUNCH_NOTE = "granted — relaunch Pomvox to pick it up"
STALE_TCC_HINT = (
...
class OnboardingWindow:
    ...
    def refresh(self, rows: list[Row], complete: bool) -> None:
        ...
        title = "You're set — try the self-test" if complete else "Pomvox setup"
    ...
    def _build(self) -> None:
        ...
        label("Welcome to Pomvox", 24, h - 52, w - 48, size=20.0, bold=True)
        label(
        ...
        y -= 46
        label("Self-test — click, then watch Pomvox type into this box:",
