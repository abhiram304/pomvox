...
struct SettingsView: View {
    ...
    private var restartBanner: some View {
        HStack(spacing: 8) {
            ...
            Text("Saving applies most changes live; these take effect after a Natter restart: \(model.pendingRestart.joined(separator: ", ")).")
    ...
    var body: some View {
        SettingsGroup("App") {
            SettingRow(
                ...
                desc: "Natter starts in the menu bar — armed and ready to dictate, no window."
            ) {
