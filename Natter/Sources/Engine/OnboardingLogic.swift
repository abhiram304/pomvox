...
/// Port of `src/natter/onboarding.py` `OnboardingFlow` — pure checklist state:
...
struct OnboardingFlow {
    ...
    static let relaunchNote = "granted — relaunch Natter to pick it up"
    static let staleTccHint =
        "Granted but still red? Remove the app from the list in System Settings "
        + "and add it back."
    static let selfTestText = "Natter works! 🎉"
