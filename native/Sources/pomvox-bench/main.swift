// pomvox-bench — M0 spike harness. Times FluidAudio Parakeet TDT (CoreML/ANE)
...
//   swift run -c release pomvox-bench [fixtures-dir] [--out path.json]
//
...
func fail(_ msg: String) -> Never {
    FileHandle.standardError.write(Data(("pomvox-bench: " + msg + "\n").utf8))
    exit(1)
}
...
var outPath = "/tmp/pomvox-native-swift.json"
...
// test whether the knobs rescue Pomvox-length utterances.
