// natter-bench — M0 spike harness. Times FluidAudio Parakeet TDT (CoreML/ANE)
...
//   swift run -c release natter-bench [fixtures-dir] [--out path.json]
//
...
func fail(_ msg: String) -> Never {
    FileHandle.standardError.write(Data(("natter-bench: " + msg + "\n").utf8))
    exit(1)
}
...
var outPath = "/tmp/natter-native-swift.json"
...
// test whether the knobs rescue Natter-length utterances.
