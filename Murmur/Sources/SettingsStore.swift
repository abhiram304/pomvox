...
/// path convention (`MURMUR_CONFIG_PATH` override for tests).
@MainActor
final class SettingsModel: ObservableObject {
    ...
    nonisolated static func defaultPath() -> String {
        if let o = ProcessInfo.processInfo.environment["MURMUR_CONFIG_PATH"], !o.isEmpty { return o }
        return NSString(string: "~/.murmur/config.toml").expandingTildeInPath
    }
